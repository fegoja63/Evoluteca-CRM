  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        p("El cliente recibe el correo a nombre de tu empresa (con tu logo); \"Evoluteca CRM\" solo aparece como una nota pequeña al pie. Si configuraste el \"Correo de la empresa\" (ver 10.1), las respuestas del cliente llegan a ese buzón; si no, el correo igual sale con la identidad de tu empresa desde el dominio del sistema."),
        ...
        p("En \"Correo de la empresa\" (solo Administrador) guardas el correo de tu organización. Se usa como \"Responder-a\" en los correos de cotización: cuando un cliente responde, la respuesta llega a ese buzón en vez de a un correo del sistema. Déjalo vacío si no quieres usarlo."),
