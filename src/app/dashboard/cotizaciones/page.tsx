  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        />
        <KpiCard label="Aceptadas" valor={cotizaciones.filter(c => c.estado === "ACEPTADA").length} emoji="✅" color="bg-violet-500" />
        <KpiCard label="Pendientes de respuesta" valor={cotizaciones.filter(c => c.estado === "ENVIADA").length} emoji="⏳" color="bg-amber-500" />
      </div>
