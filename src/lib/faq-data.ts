...
export const FAQS: Faq[] = [
  ...
  { categoria: "Clientes y contactos", pregunta: "¿Las respuestas de mis clientes quedan guardadas en el CRM?",
    respuesta: "Sí, automáticamente. Cuando el cliente responde un correo que le enviaste desde el CRM, su respuesta se registra sola en la misma tarjeta \"Correos\" de la ficha, marcada como \"Recibido\", y además te llega un aviso a tu propio correo con el texto y un botón para abrir la ficha. La captura corre cada pocos minutos, así que la respuesta puede tardar un momento en aparecer. Solo se capturan las respuestas a correos enviados desde el CRM (no reemplaza tu bandeja de entrada normal)." },
